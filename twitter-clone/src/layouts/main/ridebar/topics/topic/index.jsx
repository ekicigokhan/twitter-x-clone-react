...
export default function Topic({ item }) {
  return (
    <Link
      to={"/"}
      className="py-3 px-4 transition-colors hover:bg-[#eff4f41a] relative"
    >
      ...
      <Popover className="absolute top-1.5 right-2">
        <Popover.Button className="w-[34.75px] h-[34.75px] rounded-full text-[#71767b] flex items-center justify-center hover:bg-[#1d9bf01a] hover:text-[#1d9bf0]">
        ...
        <Popover.Panel className="w-[384px] absolute grid rounded-xl overflow-hidden top-2 right-0 bg-black shadow-box z-10">
          <button
            type="button"
            className="text-left hover:bg-white/[0.3] transition-colors py-3 px-4 flex items-center gap-3 text-[15px] text-[#e7e9ea] font-bold leading-5"
          >
            <svg viewBox="0 0 24 24" width={18.75}>
              <path
                fill="currentColor"
