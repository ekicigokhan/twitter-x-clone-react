  ...
  return (
    ...
    >
      ...
      <Popover className="absolute top-1.5 right-2">
        ...
        <Popover.Panel className="w-[384px] absolute grid rounded-xl overflow-hidden top-2 right-0 bg-[color:var(--background-primary)] shadow-box z-10">
          <button
            type="button"
            className="text-left hover:bg-white/[0.3] transition-colors py-3 px-4 flex items-center gap-3 text-[15px] font-bold leading-5"
          >
            <svg viewBox="0 0 24 24" width={18.75}>
              <path
                fill="currentColor"
