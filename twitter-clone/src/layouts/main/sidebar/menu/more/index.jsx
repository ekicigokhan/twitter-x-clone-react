    ...
    <Popover className={"relative"}>
      ...
      <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-[color:var(--background-primary)] shadow-box rounded-xl overflow-hidden">
          ...
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel>
                <Link
                  to={"/"}
                  className="flex items-center px-4 h-11 gap-3 font-medium hover:bg-[color:var(--background-secondary)] transition-colors "
                >
                  <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                    <path
                      fill="currentColor"
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="flex items-center p-4 font-bold justify-between w-full hover:bg-[color:var(--background-secondary)] transition-colors">
                Profesyonel Araçlar
                <svg
                  viewBox="0 0 24 24"
                  className={classNames("h-[1.172rem]", {
            ...
            <>
              ...
              <Disclosure.Panel>
                ...
                <button
                  ...
                  className="flex items-center px-3 h-11 gap-3 w-full font-medium hover:bg-[color:var(--background-secondary)] transition-colors "
                >
                  <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                    <path
                      fill="currentColor"
