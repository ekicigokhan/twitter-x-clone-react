...
export default function Post({ post }) {
  return (
    <div className="px-4 py-3 gap-3 first-letter:border-b border-[color:var(--background-third)] flex hover:bg-[color:var(--background-secondary)]">
      <img
      ...
      <div className="flex-1">
        <header className="leading-5 flex items-center gap-2 mb-0.5">
          ...
          >
            ...
            {post.account?.verified && (
              <svg
                viewBox="0 0 22 22"
                className="text-[color:var(--color-primary)] ml-0.5 h-[1.172rem]"
              >
                <path
                  fill="currentColor"
        ...
        <div>
          ...
          <div className="flex -ml-1.5 mt-1.5 cursor-pointer">
            <div className="flex-1 group flex items-center gap-px">
              <div className="w-[2.172rem] h-[2.172rem] transition-colors flex items-center justify-center rounded-full group-hover:text-[#1d9bf0] group-hover:bg-[#1d9bf01a] text-[color:var(--color-base-secondary)]">
            ...
            <div className="flex-1 flex items-center justify-end gap-px">
